...
pub use core::{
    Artifact, ArtifactMetadata, Fit, MAX_DECODED_PIXELS, MAX_OUTPUT_PIXELS, MAX_WATERMARK_PIXELS,
    MediaType, MetadataKind, MetadataPolicy, NormalizedTransformOptions,
